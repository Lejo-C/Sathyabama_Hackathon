...
export default function Dashboard() {
  ...
  return (
    <div className="min-h-screen bg-[#F5F6F8] font-sans antialiased text-[#171A1F] p-4 md:p-6">
      {/* Separate compact top navigation, matching the reference dashboard proportions. */}
      <header className="h-[68px] rounded-2xl border border-[#E5E7EB] bg-white px-5 md:px-6 flex items-center justify-between shadow-sm">
        <div className="flex items-center gap-2.5">
          ...
          <div className="text-[15px] font-bold tracking-tight text-[#171A1F]">JobGuard</div>
        </div>
      ...
      {/* The sidebar and content sit below the header with deliberate outer spacing. */}
      ...
      />
                ...
                {analysisResult && !isAnalyzing && (
                  <div className="space-y-5 animate-in fade-in duration-300">
                    ...
                    <RiskFactorList riskFactors={analysisResult.riskFactors} />
                  </div>
                )}
                ...
                {isAnalyzing && (
                  <div className="bg-white rounded-2xl border border-[#E5E7EB] p-12 text-center shadow-sm">
                    ...
                    <h3 className="text-sm font-bold text-[#171A1F]">Evaluating Job Signals</h3>
            ...
            {activeTab === 'overview' && (
              <div className="bg-white rounded-2xl border border-[#E5E7EB] p-8 shadow-sm">
                <h2 className="text-base font-bold text-[#171A1F]">Risk Overview</h2>
